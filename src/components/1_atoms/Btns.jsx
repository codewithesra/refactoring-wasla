...
export const ConfirmBtn = ({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`mt-4 mb-2 px-4 py-2 bg-[#648db3] text-white rounded hover:bg-[#4d6d8c] transition flex items-center justify-center gap-2 ${
...
export const NavLinkBtn = ({ to, children }) => {
  return (
    <Link
      to={to}
      className={`mb-2 px-4 py-2 border border-[#648db3] text-[#648db3] rounded-lg hover:bg-blue-50 transition dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-900/30`}
    >
      {children}
    </Link>
  );
